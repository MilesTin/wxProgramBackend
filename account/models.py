...
class user(models.Model):
    ...
    phone = models.CharField(max_length=11)#手机号为11位
    studentId = models.CharField(max_length=13,unique=True)#学号为13为
    stuIdPwd = models.CharField(max_length=30)
    address = models.CharField(max_length=50,)#这是学生的地址，跟收货地址不一样，由爬虫得到
